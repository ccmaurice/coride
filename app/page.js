      ...
      <section className="relative pt-20 pb-16 px-4 md:px-8 text-center max-w-5xl mx-auto flex-1 flex flex-col justify-center items-center">
        ...
        <div className="mb-6 animate-float flex flex-col items-center">
          ...
          <span className="mt-2 text-xs uppercase tracking-widest text-brand-cyan font-semibold flex items-center gap-1">
            <Sparkles className="w-3.5 h-3.5 text-brand-cyan inline" /> Split the Commute, Double the Impact
          </span>
        </div>

        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 leading-tight">
          Modern Carpooling for <br />
        ...
        <p className="text-base md:text-lg text-brand-text-muted max-w-2xl mb-10 leading-relaxed">
          CoRide connects riders and drivers in real time. Split travel costs, unlock local government subsidies (Nabogo model), and earn premium campus parking privileges.
        </p>
        ...
        >
          ...
          >
            Find Ride <ArrowRight className="w-4 h-4" />
          </button>
        </form>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-16">
          ...
          >
            <Car className="w-4 h-4 text-brand-cyan" /> Offer a Ride (Become a Driver)
          </Link>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-8 border-t border-white/5 bg-brand-card/40">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-12">
            Why Carpool with <span className="text-brand-cyan">CoRide</span>?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="glass-panel rounded-2xl p-6 border border-white/5 flex flex-col items-center text-center">
              ...
              <h3 className="text-base font-semibold mb-2 text-white">Trust & Safety</h3>
              <p className="text-xs text-brand-text-muted leading-relaxed">
                Prioritizing security with mandatory driver vetting, government ID checks, profile verification badges, and passenger rating feedback loops.
              </p>
            </div>
            ...
            <div className="glass-panel rounded-2xl p-6 border border-white/5 flex flex-col items-center text-center">
              ...
              <h3 className="text-base font-semibold mb-2 text-white">Smart Matcher</h3>
              <p className="text-xs text-brand-text-muted leading-relaxed">
                Advanced matching algorithms that parse route overlaps, departure windows, and personal ride preferences (such as music, conversation, or pets).
              </p>
            </div>
            ...
            <div className="glass-panel rounded-2xl p-6 border border-white/5 flex flex-col items-center text-center">
              ...
              <h3 className="text-base font-semibold mb-2 text-white">Nabogo Subsidies</h3>
              <p className="text-xs text-brand-text-muted leading-relaxed">
                Inspired by Denmark's Nabogo initiative. Local municipal authorities subsidize certified drivers per kilometer for providing community rides.
              </p>
            </div>
            ...
            <div className="glass-panel rounded-2xl p-6 border border-white/5 flex flex-col items-center text-center">
              ...
              <h3 className="text-base font-semibold mb-2 text-white">Campus Integration</h3>
              <p className="text-xs text-brand-text-muted leading-relaxed">
                PARS-inspired university parking systems. Log rides with classmate passengers and secure premium reserved parking spots on campus.
              </p>
            </div>
      ...
      <section className="py-20 px-4 md:px-8 max-w-5xl mx-auto">
        <div className="glass-panel rounded-3xl p-8 md:p-12 border border-white/10 relative overflow-hidden flex flex-col lg:flex-row items-center gap-8">
          ...
          <div className="flex-1">
            <span className="text-xs font-bold text-brand-cyan uppercase tracking-widest">Est. Savings & Subsidies</span>
            ...
            <p className="text-sm text-brand-text-muted leading-relaxed mb-6">
              CoRide helps you monetize empty car seats. By driving other community members, you unlock distance-based government subsidies and split fuel expenses.
            </p>
            
            <div className="grid grid-cols-3 gap-4 border-t border-white/5 pt-6">
              <div>
                <p className="text-xs text-brand-text-muted">Nabogo Subsidy</p>
              ...
              <div>
                <p className="text-xs text-brand-text-muted">Passenger Split</p>
              ...
              <div>
                <p className="text-xs text-brand-text-muted">Reserved Spot</p>
                <p className="text-xl md:text-2xl font-bold text-yellow-500 mt-1">Priority</p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-80 flex flex-col gap-3 shrink-0">
            <div className="p-4 rounded-2xl bg-white/5 border border-white/5 flex items-center justify-between">
              <span className="text-xs text-brand-text-muted">Daily Commute (30 km)</span>
              <span className="text-xs font-semibold text-white">Subsidies: $7.50/day</span>
            </div>
            <div className="p-4 rounded-2xl bg-white/5 border border-white/5 flex items-center justify-between">
              <span className="text-xs text-brand-text-muted">Weekly Savings</span>
              <span className="text-xs font-semibold text-brand-cyan">$37.50 earned</span>
            </div>
            <Link 
              href="/dashboard" 
